            ...
            <div className="min-h-screen overflow-hidden bg-pj-400 flex flex-wrap flex-col lg:flex-row">
                <div className="lg:w-1/2 flex sm:p-10 pt-10 p-2 flex-col justify-center">
                    <div className="flex flex-col items-center">
                        ...
                        <p className={`text-pj-300 text-lg text-justify mx-5 mt-14  ${animate ? 'animate-slide-from-left' : ''}`}>
                            ...
                            Compete on the leaderboard, and with easy login, embark on your journey to interstellar
                            triumph!
                        </p>
                    ...
                    <div className={`mt-16 mx-5 ${animate ? 'animate-slide-from-left' : ''}`}>
                        <p className="text-pj-200 font-medium text-lg">Individuals who played a role in this
                            project:</p>
                        <ul className="list-decimal ml-6 mt-2 text-pj-300">
                            <li><a href="https://www.instagram.com/regnars.klavins/" target="_blank">Regnārs Kļaviņš</a>
                            </li>
                            <li><a href="https://www.instagram.com/wherewasjeff/" target="_blank">Jevgēnijs Šuvalovs</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div className="lg:w-1/2 flex sm:p-10 p-2 h-screen">
                    <div className={`w-full justify-center items-center flex ${animate ? 'animate-slide-from-right' : ''}`}>
                        <video src={videoCosmo} autoPlay loop muted className="rounded-[30px] h-[80%] object-contain shadow-lg shadow-gray-900 dark:shadow-low-100"/>
                    </div>
                </div>
            </div>
        </>
