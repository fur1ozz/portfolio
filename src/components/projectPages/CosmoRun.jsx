            ...
            <div className="min-h-screen overflow-hidden bg-pj-400 flex flex-wrap flex-col lg:flex-row">
                <div className="lg:w-1/2 flex sm:p-10 p-2 flex-col">
                    <div className="flex flex-col items-center">
                        <h1 className="flex text-5xl font-bold text-pj-100 mt-10">Cosmo Run</h1>
                        <p className="text-pj-300 text-lg text-justify sm:mx-5 mt-14">
                            ...
                            Blast through space in this React Native game reminiscent of Subway Surfers, but with a cosmic twist. Maneuver your 2D ship to dodge planets and collect Cosmo Coins for upgrades. Compete on the leaderboard, and with easy login, embark on your journey to interstellar triumph!
                        </p>
                    ...
                    <div className="mt-16 mx-5">
                        ...
                        <ul className="list-decimal ml-6 mt-2">
                            <li><a href="https://www.instagram.com/regnars.klavins/" target="_blank">Regnārs Kļaviņš</a></li>
                            <li><a href="https://www.instagram.com/wherewasjeff/" target="_blank">Jevgēnijs Šuvalovs</a></li>
                        </ul>
                    </div>
                </div>
