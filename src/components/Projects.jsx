    ...
    return (
        <div>
            ...
            <div className="h-screen grid grid-cols-5 overflow-hidden">
                <div className="border-4 border-black  relative group filter grayscale hover:filter-none transition-all duration-300 ease-in-out cursor-pointer overflow-hidden">
