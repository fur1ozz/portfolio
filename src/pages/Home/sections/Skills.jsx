...
const SkillCard = ({ title, skills, icon: Icon, colorClass, textClass }) => (
    <div className={`p-8 rounded-[32px] flex flex-col justify-between min-h-[240px] ${colorClass} ${textClass} transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-[1.02]`}>
        ...
        <div>
            ...
            <p className="font-medium opacity-80 text-sm uppercase tracking-wider">{skills.join(', ')}</p>
        </div>
    </div>
);
