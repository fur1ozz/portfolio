...
import { Code, Palette, FileCode, Server } from "lucide-react";
...
const TickGet = () => {
    return (
        <ProjectLayout
            ...
            stack={[
                { name: "Next.js", icon: Code, colorClass: "bg-black/10 dark:bg-white/10 border border-black/20 dark:border-white/20", textClass: "text-black dark:text-white" },
                { name: "Tailwind", icon: Palette, colorClass: "bg-[#38BDF8]/20 border border-[#38BDF8]/30", textClass: "text-[#1c8ec2] dark:text-[#38BDF8]" },
                { name: "TypeScript", icon: FileCode, colorClass: "bg-[#3178C6]/20 border border-[#3178C6]/30", textClass: "text-[#235a97] dark:text-[#3178C6]" },
